...
const translations = {
  ko: {
    ...
    aboutP2: '그래서 학교에서도 가능하면 직접 만들어 보거나 실제 데이터를 다루는 활동을 하려고 합니다. 아직 세부 분야를 하나로 정해 두지는 않았고, 여러 활동을 해 보면서 알아가고 있습니다.',
    activitiesTitle: '활동',
    statusOngoing: '진행 중',
    ...
    launchTitle: '발사체',
    launchBody: '구조, 부품, 추진 방식과 실제 제작·시험 과정',
    buildTitle: '제작',
    buildBody: '직접 설계하고 만들면서 구조와 부품 배치를 맞춰가는 과정',
    testTitle: '시험·분석',
    testBody: '측정 결과를 보고 문제 원인을 찾는 과정',
    astroTitle: '천체 관측',
    astroBody: '망원경으로 직접 관측하고, 얻은 자료를 처리·분석하는 과정',
    careerTitle: '진로',
    career1: '항공우주공학 전공',
    career2: '대학원 연구',
  ...
  en: {
    ...
    aboutP2: 'At school, I try to choose activities where I can build something myself or work with real data. I have not fixed on one narrow specialty yet, and I am exploring different areas through projects and research.',
    ...
    launchTitle: 'Launch Vehicles',
    launchBody: 'Structures, components, propulsion, fabrication, and testing',
    buildTitle: 'Building',
    buildBody: 'Designing and making things while working through structure and component placement',
    testTitle: 'Testing & Analysis',
    testBody: 'Using measurements to identify problems and understand their causes',
    astroTitle: 'Astronomical Observation',
    astroBody: 'Observing directly with telescopes and processing and analyzing the resulting data',
    careerTitle: 'Path',
